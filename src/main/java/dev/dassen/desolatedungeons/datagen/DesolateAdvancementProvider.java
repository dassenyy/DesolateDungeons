...
public class DesolateAdvancementProvider extends FabricAdvancementProvider {
    public DesolateAdvancementProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookupFuture) {
