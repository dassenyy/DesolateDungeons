...
import dev.dassen.desolatedungeons.registry.key.ModLootTableKeys;
...
public class ModChestLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public ModChestLootTableProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookupFuture) {
    ...
    public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
        ...
        registryLookupFuture.thenAccept(registryLookup -> {
            lootTableBiConsumer.accept(
                ModLootTableKeys.SANDSWEPT_RUINS_COMMON,
                buildSandsweptRuinsCommon(registryLookup)
            );

            lootTableBiConsumer.accept(
                ModLootTableKeys.SANDSWEPT_RUINS_RARE,
                buildSandsweptRuinsRare(registryLookup)
            );
        }).join();
    }

    private static LootTable.Builder buildSandsweptRuinsCommon(RegistryWrapper.WrapperLookup registryLookup) {
    ...
    private static LootTable.Builder buildSandsweptRuinsRare(RegistryWrapper.WrapperLookup registryLookup) {
        return LootTable.builder()
            .pool(
                LootPool.builder()
                    ...
                    .with(
                        ItemEntry.builder(ModItems.IRON_KHOPESH)
                            .weight(8)
                            .apply(SetDamageLootFunction.builder(UniformLootNumberProvider.create(0.5f, 0.8f)))
                            .apply(EnchantWithLevelsLootFunction.builder(registryLookup, UniformLootNumberProvider.create(10.0f, 20.0f)))
                    )
